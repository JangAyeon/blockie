...
const categories: Record<CategoryKey, { title: string; tips: string[] }> = {
  fixed: {
    title: "budget.categoryTips.fixed.title",
    tips: [
  ...
  variable: {
    title: "budget.categoryTips.variable.title",
    tips: [
  ...
  irregular: {
    title: "budget.categoryTips.irregular.title",
    tips: [
  ...
  leisure: {
    title: "budget.categoryTips.leisure.title",
    tips: [
